...
A Telegram bot, **FreeGPT** ([`bot/`](bot/)), plus the curated dataset it runs on ([`data.json`](data.json) — 16 providers with *permanent* free tiers, no trial credits).
